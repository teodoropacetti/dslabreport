...
\section{Limitations and final considerations}
\begin{itemize}
...
\end{itemize}
With a one-year time horizon, the SDG 15 indicators do not offer a predictive signal strong enough to outperform a persistence baseline for future Red List Index, and neither to reliably recognize worsening cases.
